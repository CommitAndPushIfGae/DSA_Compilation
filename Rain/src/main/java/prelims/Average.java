...
public class Average extends javax.swing.JFrame {
    ...
    private void btnAvgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAvgActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Your average is: "+average, "Normal", JOptionPane.INFORMATION_MESSAGE);
        }
        else if (average >=85 && average<=89)
        {
            JOptionPane.showMessageDialog(null, "Your average is: "+average, "Good", JOptionPane.INFORMATION_MESSAGE);
        }
        else if (average >=90 && average <=94)
        {
            JOptionPane.showMessageDialog(null, "Your average is: "+average, "Very Good", JOptionPane.INFORMATION_MESSAGE);
        }
        else if (average >=95 && average <=99)
        {
            JOptionPane.showMessageDialog(null, "Your average is: "+average, "Excellent", JOptionPane.INFORMATION_MESSAGE);
        }
        else
        {
            JOptionPane.showMessageDialog(null, "Please input a proper grade", "Error", JOptionPane.WARNING_MESSAGE);
        }
